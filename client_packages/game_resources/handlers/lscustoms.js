var lsc = mp.browsers.new('package://game_resources/interface/lscustoms/home.html');
var lscSpeed = 0;
var lscBrakes = 0;
var lscBoost = 0;
var lscСlutch = 0;
...
mp.events.add('tpage', (id) => {
    ...
    if (id == "exit_menu") {
        ...
        lsc.execute(`window.location = 'package://game_resources/interface/lscustoms/${id}.html'`);

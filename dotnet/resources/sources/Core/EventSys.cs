...
namespace NeptuneEvo.Core
{
    class EventSys : Script
    {
        ...
        private void AddAdminEventLog()
        {
            try
            {
                GameLog.EventLogAdd(AdminEvent.Admin.Name, AdminEvent.Name, AdminEvent.MembersLimit, Database.ConvertTime(AdminEvent.Started));
            }
            catch (Exception e)
            {
        ...
        private void UpdateLastAdminEventLog()
        {
            try
            {
                GameLog.EventLogUpdate(AdminEvent.Admin.Name,AdminEvent.EventMembers.Count,AdminEvent.Winner.Name,AdminEvent.Reward,Database.ConvertTime(DateTime.Now),AdminEvent.RewardLimit, AdminEvent.MembersLimit, AdminEvent.Name);
            }
            catch (Exception e)
            {

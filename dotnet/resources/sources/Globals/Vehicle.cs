            ...
            NAPI.Task.Run(() =>
            {
                ...
                foreach (Vehicle veh in allVehicles)
                {
                    ...
                    try
                    {
                        ...
                        if (!Globals.VehicleStreaming.GetEngineState(veh)) continue;
        ...
        public static void onClientEvent(Player sender, string eventName, params object[] args)
        {
            switch (eventName)
            {
                ...
                case "engineCarPressed":
                    ...
                    if (Globals.VehicleStreaming.GetEngineState(vehicle)) Commands.RPChat("me", sender, "завел(а) транспортное средство");
